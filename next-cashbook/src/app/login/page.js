...
import { Mail, Lock, LogIn, Loader, Globe, Github, Linkedin, Code, ToolboxIcon, Music, Music2Icon } from "lucide-react";
            ...
            <div className="relative z-10 w-full max-w-md my-auto pt-10">
                <div className="bg-gradient-to-b from-gray-800/50 to-gray-900/50 backdrop-blur-xl border border-gray-700/30 rounded-2xl p-8 shadow-2xl">
                    <div className="mb-8 text-center">
                        ...
                        <p className="text-gray-400 text-sm">Organize, track, and improve every part of your daily life.</p>
                    </div>
                ...
                <div className="py-12 text-center">
                    ...
                    <div className="flex justify-center gap-6">
                        <a href="https://jira-dsa.vercel.app/dashboard" className="p-2.5 bg-gray-800/40 hover:bg-gray-800/80 border border-gray-700/50 hover:border-green-500/30 rounded-xl text-gray-400 hover:text-green-400 transition-all duration-300 transform hover:-translate-y-1 group">
                            <Code size={18} className="group-hover:animate-pulse" />
                        </a>
                        <a href="https://service-care-kappa.vercel.app" className="p-2.5 bg-gray-800/40 hover:bg-gray-800/80 border border-gray-700/50 hover:border-green-500/30 rounded-xl text-gray-400 hover:text-green-400 transition-all duration-300 transform hover:-translate-y-1 group">
                            <ToolboxIcon size={18} />
                        </a>
