            ...
            <form id="addTransactionForm" onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                id="AmountInputField"
                  ...
                  step="0.01"
                  min="0"
                  className="w-full px-4 py-3 border-2 border-gray-300 bg-white text-gray-900 placeholder-gray-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 hover:border-gray-400 transition-colors"
                  required
                />
              </div>
              ...
              <div>
                ...
                id="categoryDropDown"
                  ...
                  required
                >
                  <option data-testid="dropdown_option" value="">Select a category</option>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows="4"
                  className="w-full px-4 py-3 border-2 border-gray-300 bg-white text-gray-900 placeholder-gray-500 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 hover:border-gray-400 transition-colors resize-none"
                />
              </div>
